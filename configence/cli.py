...
import click
import typer
from .types import ConfigenceEntry
from typer.main import Typer


def create_click_cli(configence_entries: Dict[str, ConfigenceEntry], callback: Callable):
    cli = callback
    for key, entry in configence_entries.items():
